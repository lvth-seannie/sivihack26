...
export default {
  ui: {
    ...
    sectionEmptyFiltered: 'Không có kết quả phù hợp với các bộ lọc hiện tại trong mục này.',
    ...
    verdictToggleLabel: 'Hiện/ẩn nhóm kết quả',
    verdictToggle_CANDIDATE: 'Ứng viên',
    verdictToggle_FLAG: 'Cảnh báo',
    verdictToggle_HARD_FAIL: 'Loại trừ',
    reasonTypeLabel: 'Loại lý do',
    reasonCategory_distance: 'Khoảng cách',
    reasonCategory_value: 'Giá trị hợp đồng',
    reasonCategory_guarantee: 'Bảo lãnh',
    reasonCategory_references: 'Tham chiếu',
    reasonCategory_capability: 'Năng lực',
    reasonCategory_extraction: 'Chưa được đọc',
    sourceAvailableLabel: 'Có tài liệu nguồn',
    reasonChartTitle: 'Lý do loại trừ',
  },
  reasons: {
    OUT_OF_RADIUS: (ctx) =>
