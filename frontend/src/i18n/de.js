...
export default {
  ui: {
    ...
    sectionEmptyFiltered: 'Kein Treffer für die aktuellen Filter in diesem Bereich.',
    ...
    verdictToggleLabel: 'Ergebnisgruppen ein-/ausblenden',
    verdictToggle_CANDIDATE: 'Kandidat',
    verdictToggle_FLAG: 'Hinweis',
    verdictToggle_HARD_FAIL: 'Ausschluss',
    reasonTypeLabel: 'Ausschlussgrund',
    reasonCategory_distance: 'Entfernung',
    reasonCategory_value: 'Auftragswert',
    reasonCategory_guarantee: 'Bürgschaft',
    reasonCategory_references: 'Referenzen',
    reasonCategory_capability: 'Leistungsfähigkeit',
    reasonCategory_extraction: 'Noch nicht ausgewertet',
    sourceAvailableLabel: 'Quelle verfügbar',
    reasonChartTitle: 'Ausschlussgründe',
  },
  reasons: {
    OUT_OF_RADIUS: (ctx) =>
